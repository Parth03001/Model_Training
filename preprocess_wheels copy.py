...
def center_crop_hub(image, crop_ratio=0.35):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", type=str, default="Wheel_Data_Processed_test", help="Output folder")
    parser.add_argument("--crop-ratio", type=float, default=0.35, help="Center crop ratio (default 0.35)")
